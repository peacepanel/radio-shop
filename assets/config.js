...
window.SHEETS_CONFIG = {
  ...
  // ورقة الإعدادات للحصول على أسماء أوراق المنتجات (بدلاً من API أسماء الأوراق)
  CONFIG_SHEET: 'Config',
  CONFIG_PRODUCTS_LIST_RANGE: 'A2:A', // عمود يحوي أسماء الأوراق (الفئات)

  // خرائط أعمدة المنتجات (يفضّل وجود رؤوس أعمدة مطابقة، وإلا تُستخدم الفهارس الاحتياطية)
  PRODUCT_HEADERS: {
  ...
  // فهارس احتياطية (0-based) لو ما وجد رؤوس
